...
it('allows same-site cart referrer hop for guest session', function (): void {
    $_COOKIE['wordpress_logged_in_order'] = '1';
    $_GET['referrer'] = '/cart/?wgp_cart_key=abc123';
...
it('redirects guest session on restricted page when referrer host is different', function (): void {
    ...
    expect($redirect_url)->toBe('https://example.com/cart/');
